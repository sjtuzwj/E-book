...
import com.zwj.ebook.ServiceImpl.OrderServiceImpl;
...
public class OrderController {
    ...
    @RequestMapping(value="/searchb/{id}",method= RequestMethod.GET)
    public List<Order> searchOrderB(@PathVariable String id){
        logger.info("从数据中读取"+id);
        return orderService.searchOrderB(id);
    }
    @RequestMapping(value="/search/{id}",method= RequestMethod.GET)
    public List<Order> searchOrder(@PathVariable String id){
        logger.info("从数据中读取"+id);
